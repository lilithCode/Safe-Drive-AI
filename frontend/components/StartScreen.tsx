...
export default function StartScreen({
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-[#F2E8D9] flex flex-col justify-center items-center text-[#3D2B1F] p-6 relative overflow-hidden" 
    >
      {/* Background Glow */}
      ...
      {/* ICON */}
      {/* -------------------------------- */}
      <div className="gsap-item opacity-0 mb-10">
        <div className="floating-card w-28 h-28 sm:w-36 sm:h-36 bg-[#3D2B1F] rounded-3xl flex items-center justify-center shadow-2xl border border-[#4D392C]">
          ...
          {appState === "IDLE" && (
            <Car
              className="text-amber-300 w-14 h-14 sm:w-20 sm:h-20"
              strokeWidth={1.5}
            />
          )}
          ...
          {appState === "INITIALIZING" && (
            <Loader2
              className="animate-spin text-amber-300 w-14 h-14 sm:w-20 sm:h-20"
              strokeWidth={1.5}
            />
          )}
          ...
          {appState === "READY" && (
            <CheckCircle2
              className="text-green-300 w-14 h-14 sm:w-20 sm:h-20"
              strokeWidth={1.5}
            />
          )}
        </div>
      ...
      <div className="text-center z-10">
        ...
        {/* TITLE */}
        <h1 className="gsap-item opacity-0 text-5xl sm:text-7xl font-black tracking-tight uppercase mb-3">
          SafeDrive{" "}
        ...
        {/* SUBTITLE */}
        <div className="gsap-item opacity-0 flex items-center justify-center gap-3 mb-10">
        ...
        {/* -------------------------------- */}
        {appState === "IDLE" && (
          <div className="gsap-item opacity-0 flex flex-col items-center">
            
            <p className="text-sm sm:text-base text-[#8C6A53] mb-10 max-w-md leading-relaxed">
              Initialize the AI engine to activate
              real-time driver monitoring and
      ...
      {/* FOOTER */}
      {/* -------------------------------- */}
      <div className="gsap-item opacity-0 absolute bottom-10 flex items-center gap-2 text-[#8C6A53] opacity-70">
